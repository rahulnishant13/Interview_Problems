// StringComparatorIsValid checks if the given condition is valid.
// The approach uses the concept of topological sorting to determine if there are any cycles.
// If a cycle is present, the condition is invalid.
// Solution 1: Check if a cycle exists.
// Solution 2: Use the topological sort algorithm to verify if an ordering of all elements is possible.
// If the sorted list's count matches the map's key set size, then the condition is valid.


import java.util.*;

public class StringComparatorIsValid {
